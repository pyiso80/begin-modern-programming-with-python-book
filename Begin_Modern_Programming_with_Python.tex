...
\AtBeginEnvironment{pythoncode}{\let\special\pythoncodespecial} 
\def\pythoncodespecial{\kern0pt\primitive\special}
\makeatletter
\AtBeginEnvironment{pythoncode}{\dontdofcolorbox}
\def\dontdofcolorbox{\renewcommand\fcolorbox[4][]{##4}}
\makeatother
