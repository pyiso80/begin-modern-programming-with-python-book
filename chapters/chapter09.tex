...
ကလပ်စ်နဲ့ အော့ဘ်ဂျက်တွေ အကြောင်း အထိုက်အလျှောက် လေ့လာပြီးနောက် ၎င်းတို့ကို ပရိုဂရမ် တည်\allowbreak ဆောက်ရာမှာ အသုံးချတတ်အောင် ဆက်လက် လေ့လာကြရပါမယ်။ လက်တွေ့ရေး လေ့ကျင့်ဖို့ လိုပါတယ်။ အော့ဘ်ဂျက်သဘောတရား အခြေပြု ပရိုဂရမ်ရေးသား တည်ဆောက်တာကို \fEn{\textit{Object-oriented Programming} (OOP)} လို့ခေါ်ပါတယ်။ ဒီနည်းနဲ့ တည်ဆောက်ထားတဲ့ ပရိုဂရမ်တွေကို \fEn{object-oriented program/software} လို့ ဆိုနိုင်ပါတယ်။ စလေ့လာသူတွေ အတွက် အထောက်အကူဖြစ်စေမဲ့ နမူနာ \fEn{object-oriented program} လေးတစ်ခုကို လေ့လာကြည့်ပါမယ်။ 

\subsection*{A Simple Banking Application}
\fEn{S Bank} ဆိုတဲ့ ဘဏ်တစ်ခုအတွက် ပရိုဂရမ်တစ်ခု ရေးပေးရမယ်လို့ စိတ်ကူးကြည့်ပါ။ ဘဏ်အကောင့် အသစ်ဖွင့်တဲ့အခါ အောက်ပါ အချက်အလက်တွေ လိုအပ်တယ်။ \fEn{S Bank} က လောလောဆယ် ရန်ကုန်၊ မန္တလေးနဲ့ နေပြည်တော် ဘဏ်ခွဲ သုံးခုပဲ ရှိတယ်။ 
%
...
ငွေလွှဲတာကတော့ လွှဲမဲ့အကောင့်၊ လက်ခံမဲ့အကောင့် နှစ်ခုလိုပါမယ်။ လွှဲမဲ့ဟာနဲ့ လက်ခံမဲ့ဟာက အကောင့်တစ်ခုတည်း ဖြစ်မနေသင့်ပါဘူး။ 
%
\begin{minted}[frame=lines, framerule=0pt,escapeinside=ßß]{text}
ß\fEnBf{Transfer}ß
...
%ဒီအော့ဘ်ဂျက်နှစ်ခုဟာ ‘ရှိတယ်’ ဆိုတဲ့ အဓိပ္ပါယ်နဲ့ ဆက်စပ်နေတာပါ။ ‘အကောင့်တစ်ခုမှာ အကောင့်ပိုင်ရှင် တစ်ယောက် ရှိတယ်’ 

%\fCode{Account} နဲ့ \fCode{Holder}  \fEn{instance} ဘယ်လို ချိတ်ဆက်မလဲက နားလည်ဖို့ 
...
%\betweenminted{\medskipamount}
%\begin{py}
%acc1_new = Account('Kathy', '0086-6002-1111', Decimal('100_000.00'))
%acc1_new.deposit(Decimal('25_000.00'))
%
%print(acc1_new.balance)
%acc1_new.withdraw(Decimal('35_000.00'))
%print(acc1_new.balance)
%\end{py}
%%
