...
\end{py}
%
ရေးရပါမယ်။ ဝိုက်ကွင်းထဲမှာ \fEn{handle} လုပ်မဲ့ \fEn{exception} တွေကို ထည့်ပေးပါတယ်။ နောက်ထပ်နည်း လမ်းတစ်ခုက ဒီ \fEn{exception} နှစ်ခုရဲ့ \fEn{superclass} ဖြစ်တဲ့ \fCode{IOError} ကို \fEn{handle} လုပ်လို့လည်း ရပါတယ်။
%
\begin{py}
def fun_b1():
    try:
