...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0)
        {\includegraphics[width=.98\textwidth, trim={2.4mm 2mm 2mm 2mm},clip]{images/pycharm_install/1.jpg}};
    \drawshadow{image}
\end{tikzpicture}
\caption{} 
\label{fig:pychmhome}
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0)
        {\includegraphics[width=.98\textwidth, trim={2.4mm 12cm 2mm 2mm},clip]{images/pycharm_install/2.jpg}};
    \drawshadow{image}
\end{tikzpicture}
\caption{} 
...
\begin{mytcbox}
\noindent \qquad ဒီစာရေးနေချိန် လက်ရှိ \fEn{PyCharm} ဗားရှင်းက ၂၀၂၃ ပါ။ သိပ်မကြာခင် ၂၀၂၄ ထွက်ပါတော့မယ်။ အကယ်၍ လက်ရှိဗားရှင်းထက် နိမ့်တဲ့ဗားရှင်းတွေကို ဒေါင်းလုဒ် လုပ်ချင်ရင် အောက်ပါ လင့်ကို သွားပါ။ 
%
\begin{minted}[frame=lines, framerule=0pt]{text}
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0)
        {\includegraphics[width=.98\textwidth, trim={2.4mm 2mm 2mm 2mm},clip]{images/pycharm_install/3.jpg}};
    \drawshadow{image}
\end{tikzpicture}
\caption{} 
\label{fig:schpychm}
...
%စာစီစာရိုက်အတွက် \fEn{Microsoft Word} ကိုပဲ သုံးလို့ရတာတော့ မဟုတ်ပါဘူး။ အခြား စာစီစာရိုက် ဆော့ဖ်ဝဲတွေလည်း သုံးလို့ရပါတယ်။ ထိုနည်းတူစွာပဲ \fEn{Python} အတွက် \fEn{PyCharm} အပြင် အခြား \fEn{IDE} တွေလည်း ရှိပါတယ်။ \fEn{Visual Studio Code (VS Code)} ဟာ အသုံးများတဲ့ ကုဒ်အယ်ဒီတာ တစ်ခုပါ။ နောက်ပိုင်းမှာ \fEn{VS Code} နဲ့ \fEn{Python} တွဲဖက်အသုံးပြုဖို့အတွက် အင်စတောလ် လုပ်နည်းကိုလည်း ဖော်ပြပေးထားပါတယ်။ 

%ကွန်ပျူတာ အခြေခံအားနည်းပြီး အတွေ့အကြုံနည်းသေးတဲ့ စလေ့လာသူအနေနဲ့ \fEn{PyCharm} အသုံး\allowbreak ပြုသင့်ပါတယ်။ \fEn{VS Code} နဲ့ဆိုရင် နည်းနည်းပိုခက်မယ် ထင်တယ်။ ကွန်ပျူတာ အခြေခံပိုင်တယ်ဆိုရင်တော့ နှစ်သက်ရာတစ်ခု ရွေးချယ် အသုံးပြုနိုင်ပါတယ်။ \fEn{VS Code} ကတော့ ဖိုင်ဆိုက်ဇ်သေးပြီး နည်းနည်းပိုပေါ့ပါးတယ်။ မိမိရဲ့ ကွန်ပျူတာမှာ \fEn{PyCharm} အသုံးပြုရတာ နှေးလွန်းနေရင်တော့ \fEn{VS Code} ကို စမ်းကြည့်သင့်ပါတယ်။ အရမ်းတော့လည်း ပိုမခက်ပါဘူး။
...
\begin{mytcbox}
\noindent\qquad မှတ်ချက်။\qquad ။ ပရောဂျက် အသစ်ဆောက်တိုင်း လိုအပ်တဲ့ လိုက်ဘရီကို တစ်ခါထပ်ပြီး အင်စတောလ် လုပ်ရပါမယ်။ ကားရဲလ်အခန်း ပရောဂျက်တစ်ခုစီအတွက် \fEnSnd{stanfordkarel} လိုက်ဘရီကို အထက်ဖော်ပြပါအတိုင်း အင်စတောလ် လုပ်ဖို့လိုတယ်။
\end{mytcbox}
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0)
        {\includegraphics[width=.98\textwidth, trim={2.4mm 2mm 2mm 2mm},clip]{images/pycharm_install/no_lib.jpg}};
    \drawshadow{image}
\end{tikzpicture}
\caption{} 
\label{fig:}
...
ပြီးတဲ့အခါ အင်စတော်လာဖိုင်ကို ညာကလစ်နှိပ်ပြီး ဖွင့်ပါ (ပုံ \fRefNo{\ref{fig:vsinstlropn}} မှာ ပြထားပါတယ်)။ အင်စတောလ် ဒိုင်ယာလော့ဂ်ဘောက်စ် ပွင့်လာရင် \mytcboxinl{\fEnSnd{I accept the agreement}} ကို ချက်ခ်လုပ်၍ \fEnSnd{Next>} တစ်ခုပြီးတစ်ခု ဆက်နှိပ်သွားပြီး နောက်ဆုံးမှာ  \fEnSnd{Install} နှိပ်ပါ။ အင်စတောလ်လုပ်နေတာကို ခဏစောင့်ပြီး၊ ပြီးသွားရင် \fEnSnd{Finish} နှိပ်ပါ။  
...
%
\begin{mytcbox}
\noindent \qquad မိမိ လက်ရှိ \fEn{Home} ဖိုဒါကို  \mytcboxinl{\fEnSnd{C:}} \fEn{drive} ရဲ့ \mytcboxinl{\fEnSnd{Users}}  ဖိုဒါထဲမှာ တွေ့နိုင်ပါတယ်။ \mytcboxinl{\fEnSnd{Win + R}} ရှော့ကတ်နှိပ်ပြီး \mintinline{text}|%userprofile%| ရိုက်ထည့်၊ \fEnSnd{Ok} လုပ်ပြီး \fEn{Home} ဖိုဒါကို သွားနိုင်ပါတယ်။ အကယ်၍ မသွားတတ်ရင်လည်း ပြဿနာမရှိပါဘူး။ ကိုယ့်အတွက် လွယ်ကူမဲ့ \fEnSnd{Desktop, Downloads, Documents} တစ်ခုခုထဲမှာ \fEn{VS Code} အတွက် ဖိုဒါတစ်ခု ထားလည်းရတယ်။
\end{mytcbox}

\mytcboxinl{\fEnSnd{meet\_karel}} ဖိုဒါ (\fEnSnd{.zip} ဖိုင်မဟုတ်ပါ) ကို အထက်ပါအတိုင်း အသစ် ဆောက်ထားတဲ့ \fEn{VS Code} သီးသန့်ဖိုဒါထဲကို ကော်ပီကူးထည့်ပါ။ ၎င်း \mytcboxinl{\fEnSnd{meet\_karel}} ဖိုဒါကို \fEn{VS Code} \mytcboxinl{\fEnSnd{File}} မီနူးမှ ဖွင့်ပါ။ ပုံ (\fRefNo{\ref{fig:opnmtkrl}}) တွင်ကြည့်ပါ။
