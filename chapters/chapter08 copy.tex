...
%ပြတင်းပေါက် တစ်ခုနဲ့တစ်ခု တူနေတာကဘာတွေလဲ၊ ကွာခြားနေတာက ဘာတွေဖြစ်မလဲ ဆန်းစစ်ကြည့်ရင်
%\begin{itemize}
%  \item တစ်ခုနဲ့တစ်ခု နေရာမတူပါဘူး
%  \item ပါဝင်တဲ့ မှန်ချပ် အရေအတွက် မတူဘူး (တိုင်နဲ့တန်း အရေအတွက်)
%  \item အရောင်တူတယ်
%  \item မှန်ချပ်တစ်ခုစီက အရွယ်တူတယ်
%\end{itemize}
%ကွာခြားတာတွေကို \mParameter အနေနဲ့ ထားသင့်တယ်လို့ အကြမ်းဖျဉ်းပြောလို့ရတယ်။ ဘယ်နေရာမှာ ဆွဲရမလဲ သတ်မှတ်ပေးဖို့ \((x, y)\) %ကိုဩဒိနိတ်၊ တိုင်နဲ့ တန်း အရေအတွက်တွေကို \mParameter\ အနေနဲ့ ထားပြီး ပြတင်းပေါက်ဆွဲပေးတဲ့ \mMethod ကို %အခုလိုသတ်မှတ်နိုင်ပါတယ်။

\section{တန်ဖိုးပြန်ပေးခြင်း၊ မပေးခြင်း ဘာကွာခြားလဲ}

\section{\fSecCodeBf{return}}
\fCode{return} ဟာ ဖန်ရှင်ကနေ သူ့ကိုခေါ်တဲ့သူ (သို့) ခေါ်ထားတဲ့နေရာဆီ ပြန်ရောက်သွားစေတဲ့ စတိတ်မန့်လို့ သိထားပြီးပြီ။ သတိပြုမိသင့်တဲ့ အသေးစိတ်အချက် တချို့ကို ဆက်ကြည့်ရအောင်။ 
%
\begin{py}
def ge_sign(r):
    if r > 0:
